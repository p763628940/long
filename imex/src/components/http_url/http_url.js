...
let _host = localhostDev ? 'https://api.imx.com' : 'http://api.tanghs.com';
// _host = 'http://api.freecoin.test';
/*判断用户登录的机型*/
var u = navigator.userAgent;
var clientId; /*id*/
var clientSecret; /*用的串*/
/*手机浏览器访问*/
// if(window.location.host) {
// 	/*正式*/
// 	if(location.host.indexOf("imx.com") != -1) {
// 		clientId = 7;
// 		clientSecret = "sGX2m1lZrpZrJ2sUIo4p36Xehsf0C6oAQkIxXZXL"
// 	} else {
		clientId = 3;
		clientSecret = "rf7oU2CL4xX6nsWGZkCbWKvQWBjYoLfKRkNxL5PO"
// 	}
// } else {
// 	if(u.indexOf('Android') > -1) {
// 		//安卓手机
// 		clientId = 6;
// 		clientSecret = "n6FtJ3e0dN9rkk9ImF7ym2rOUmDSouzwuZ5oioqD";
// 	} else if(u.indexOf('iPhone') > -1) {
// 		//苹果手机
// 		clientId = 5;
// 		clientSecret = "gEibuM2ejuolRQsW1pNsiSsJZqD7ZLGZRPEEGZgn";
// 	}
// }
let httpUrl = {
	...
	"group": _host + "/api/v1/tradingfees/group", //获取回购总量
	...
	"createApi": _host + "/api/v1/createApi", ///创建api
	"listApi": _host + "/api/v1/listApi", ///api列表
	"delApi": _host + "/api/v1/delApi", ///api删除
	"editApi": _host + "/api/v1/editApi", ///api编辑
	...
	"rule": _host + "/api/v1/tradingfees/rule", ///回购记录
	////////////法币交易
	...
	"addFeedback": _host + "/api/v1/addFeedback", /////提交bug
	///////空投接口////
  ...
  /////eos兑换fo/////
  "currencyConvert":_host + "/api/v1/currencyConvert",  //兑换币种
  "currencyConvertPrice":_host + "/api/v1/currencyConvertPrice", //兑换币种价格
